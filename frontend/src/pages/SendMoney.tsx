...
const SendMoney = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-w-screen open-sans-1234">
      ...
      <div className="flex flex-col justify-center items-center z-10 bg-slate-100 w-[200px] h-[300px] md:w-[600px] md:h-[500px] absolute px-4 py-1 md:px-7 md:py-2 rounded-xl">
        <h1 className="font-bold text-lg mb-2 md:text-3xl md:mb-5 text-center">Transfer Amount</h1>
        <div className="text-center text-xs md:text-xl flex justify-center items-center gap-1 md:gap-2 mt-5">
        <img
            src={userSVG}
            alt="User Icon"
        ...
        <p className="w-full p-1 text-xs md:text-lg mt-4">Amount (in $):</p>
        <input type="text" placeholder="Enter amount" className="p-3 w-full text-xs md:text-md mt-1" ref={amountRef}/>
